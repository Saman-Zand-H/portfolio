<template>
    <router-link 
        ...
        class="h-fit w-fit md:w-2/3 mx-auto flex flex-wrap transition-colors gap-3 duration-200 p-2 sm:p-5 bg-contain rounded-3xl text-white"
        >
        ...
        <div class="flex flex-col h-fit justify-center gap-1">
